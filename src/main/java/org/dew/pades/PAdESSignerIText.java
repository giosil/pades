...
class PAdESSignerIText
{
  ...
  public PAdESSignerIText(String keystoreFile, String password, String alias)
      throws Exception
  {
    this(keystoreFile, password, alias, password);
  }
  
  public PAdESSignerIText(String keystoreFile, String password, String alias, String passwordKey)
    throws Exception
  {
  ...
  public PAdESSignerIText(Certificate certificate, PrivateKey privateKey, Certificate[] certChain)
    throws Exception
  {
